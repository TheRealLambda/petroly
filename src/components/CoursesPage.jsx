    ...
    <div className="courses_page">
      <div ref={searchPage} className="search_page bgcolor-BG">
        <div className="search_field">
          <div onClick={closeSearchPage} className="svg bgcolor-BG button_effect_1_dark">
      ...
      <div className="top">
        <Link to="/app/schedule" style={{textDecoration: "none"}}>
          <div className="bgcolor-white button_effect_1_dark">
        ...
        <div onClick={openSearchPage} className="bgcolor-white button_effect_1_dark">
      ...
      <div onClick={handleTermsSlider} className="terms">
        <div data-term="241" className="text-14-medium bgcolor-white color-accent button_effect_1_dark chosen">241</div>
        <div data-term="233" className="text-14-medium bgcolor-white color-accent button_effect_1_dark">233</div>
        <div data-term="232" className="text-14-medium bgcolor-white color-accent button_effect_1_dark">232</div>
        <div data-term="231" className="text-14-medium bgcolor-white color-accent button_effect_1_dark">231</div>
      </div>
      ...
      <div onClick={openSearchModal} className="add_button bgcolor-primary button_effect_1_darker">
