...
export default function ShowTaskForm({ task, closeModal, setAction, openChangeListMenu }) {
  ...
  return (
    <div className="show_task_form bgcolor-BG modalScrollContainer">
      ...
      <div className="top modalDragArea">
        ...
        <div onClick={openChangeListMenu} className="change_list bgcolor-BG button_effect_1_dark">
          <span className="text-16-medium color-accent">Workout</span>
      ...
      <div className="title">
        <div onClick={completeTask} className="check_circle bgcolor-BG button_effect_1_dark">
          {task.completed ? 
           ...
           :<svg className="fillcolor-accent-80" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#5f6368"><path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
          }
        </div>
        <p className={"task_title text-20-medium color-accent-80"+(task.completed?" line_through":" ")}>{task.title}</p>
      </div>
      <div className="description text-14-medium color-accent-80">{task.description}</div>
    </div>
  )
}